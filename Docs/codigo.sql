...
CREATE TABLE IF NOT EXISTS `SUBEdb`.`Persona` (
  ...
  `idDescuentoTarifaSocial` INT NULL,
  `idDescuentoBoletoEstudiantil` INT NULL,
  PRIMARY KEY (`idPersona`),
  INDEX `fk_Persona_DescuentoTarifaSocial1_idx` (`idDescuentoTarifaSocial` ASC),
  INDEX `fk_Persona_DescuentoBoletoEstudiantil1_idx` (`idDescuentoBoletoEstudiantil` ASC),
  CONSTRAINT `fk_Persona_DescuentoTarifaSocial1`
    FOREIGN KEY (`idDescuentoTarifaSocial`)
    REFERENCES `SUBEdb`.`DescuentoTarifaSocial` (`idDescuento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Persona_DescuentoBoletoEstudiantil1`
    FOREIGN KEY (`idDescuentoBoletoEstudiantil`)
    REFERENCES `SUBEdb`.`DescuentoBoletoEstudiantil` (`idDescuento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
ALTER TABLE TarjetaSUBE ALTER COLUMN activa SET DEFAULT 0;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `SUBEdb`.`LectoraSubte` (
  `idEstacion` INT NOT NULL,
  `Lectora_idLectora` INT NOT NULL,
  PRIMARY KEY (`idEstacion`, `Lectora_idLectora`),
  INDEX `fk_LectoraSubte_Lectora1_idx` (`Lectora_idLectora` ASC),
